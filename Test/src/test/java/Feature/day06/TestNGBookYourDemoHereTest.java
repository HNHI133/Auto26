...
public class TestNGBookYourDemoHereTest {
    ...
    @Test
    public void testSubmitWithoutFirstName() {
        ...
        WebElement errorMessage = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[contains(text(),'First Name is required')]")));
        Assert.assertTrue(errorMessage.isDisplayed(), "Error message for missing First Name is not displayed.");
    }
